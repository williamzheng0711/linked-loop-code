...
class Graph8(ccsfg.Encoding):
    def __init__(self, seclength=16):
        ...
        self.__InfoIndices = [1, 2, 4, 5, 7, 8, 10, 11]
        super().__init__(self.__Check2VarEdges, self.__InfoIndices, seclength)
        self.maxdepth=8
...
class CCSDS_ldpc_n128_k64(ccsfg.Encoding):
    def __init__(self, seclength=1):
        # https://www.uni-kl.de/fileadmin/chaco/public/alists_ccsds/CCSDS_ldpc_n128_k64.alist
        self.__Check2VarEdges = []
        self.__Check2VarEdges.append([1, 8, 19, 47, 55, 81, 110, 113])
        self.__Check2VarEdges.append([2, 9, 20, 48, 56, 82, 111, 114])
        self.__Check2VarEdges.append([3, 10, 21, 33, 57, 83, 112, 115])
        self.__Check2VarEdges.append([4, 11, 22, 34, 58, 84, 97, 116])
        self.__Check2VarEdges.append([5, 12, 23, 35, 59, 85, 98, 117])
        self.__Check2VarEdges.append([6, 13, 24, 36, 60, 86, 99, 118])
        self.__Check2VarEdges.append([7, 14, 25, 37, 61, 87, 100, 119])
        self.__Check2VarEdges.append([8, 15, 26, 38, 62, 88, 101, 120])
        self.__Check2VarEdges.append([9, 16, 27, 39, 63, 89, 102, 121])
        self.__Check2VarEdges.append([1, 10, 28, 40, 64, 90, 103, 122])
        self.__Check2VarEdges.append([2, 11, 29, 41, 49, 91, 104, 123])
        self.__Check2VarEdges.append([3, 12, 30, 42, 50, 92, 105, 124])
        self.__Check2VarEdges.append([4, 13, 31, 43, 51, 93, 106, 125])
        self.__Check2VarEdges.append([5, 14, 32, 44, 52, 94, 107, 126])
        self.__Check2VarEdges.append([6, 15, 17, 45, 53, 95, 108, 127])
        self.__Check2VarEdges.append([7, 16, 18, 46, 54, 96, 109, 128])
        self.__Check2VarEdges.append([7, 17, 32, 33, 50, 65, 97, 120])
        self.__Check2VarEdges.append([8, 17, 18, 34, 51, 66, 98, 121])
        self.__Check2VarEdges.append([9, 18, 19, 35, 52, 67, 99, 122])
        self.__Check2VarEdges.append([10, 19, 20, 36, 53, 68, 100, 123])
        self.__Check2VarEdges.append([11, 20, 21, 37, 54, 69, 101, 124])
        self.__Check2VarEdges.append([12, 21, 22, 38, 55, 70, 102, 125])
        self.__Check2VarEdges.append([13, 22, 23, 39, 56, 71, 103, 126])
        self.__Check2VarEdges.append([14, 23, 24, 40, 57, 72, 104, 127])
        self.__Check2VarEdges.append([15, 24, 25, 41, 58, 73, 105, 128])
        self.__Check2VarEdges.append([16, 25, 26, 42, 59, 74, 106, 113])
        self.__Check2VarEdges.append([1, 26, 27, 43, 60, 75, 107, 114])
        self.__Check2VarEdges.append([2, 27, 28, 44, 61, 76, 108, 115])
        self.__Check2VarEdges.append([3, 28, 29, 45, 62, 77, 109, 116])
        self.__Check2VarEdges.append([4, 29, 30, 46, 63, 78, 110, 117])
        self.__Check2VarEdges.append([5, 30, 31, 47, 64, 79, 111, 118])
        self.__Check2VarEdges.append([6, 31, 32, 48, 49, 80, 112, 119])
        self.__Check2VarEdges.append([5, 18, 33, 48, 63, 76, 81, 116])
        self.__Check2VarEdges.append([6, 19, 33, 34, 64, 77, 82, 117])
        self.__Check2VarEdges.append([7, 20, 34, 35, 49, 78, 83, 118])
        self.__Check2VarEdges.append([8, 21, 35, 36, 50, 79, 84, 119])
        self.__Check2VarEdges.append([9, 22, 36, 37, 51, 80, 85, 120])
        self.__Check2VarEdges.append([10, 23, 37, 38, 52, 65, 86, 121])
        self.__Check2VarEdges.append([11, 24, 38, 39, 53, 66, 87, 122])
        self.__Check2VarEdges.append([12, 25, 39, 40, 54, 67, 88, 123])
        self.__Check2VarEdges.append([13, 26, 40, 41, 55, 68, 89, 124])
        self.__Check2VarEdges.append([14, 27, 41, 42, 56, 69, 90, 125])
        self.__Check2VarEdges.append([15, 28, 42, 43, 57, 70, 91, 126])
        self.__Check2VarEdges.append([16, 29, 43, 44, 58, 71, 92, 127])
        self.__Check2VarEdges.append([1, 30, 44, 45, 59, 72, 93, 128])
        self.__Check2VarEdges.append([2, 31, 45, 46, 60, 73, 94, 113])
        self.__Check2VarEdges.append([3, 32, 46, 47, 61, 74, 95, 114])
        self.__Check2VarEdges.append([4, 17, 47, 48, 62, 75, 96, 115])
        self.__Check2VarEdges.append([1, 18, 42, 49, 62, 79, 82, 97])
        self.__Check2VarEdges.append([2, 19, 43, 50, 63, 80, 83, 98])
        self.__Check2VarEdges.append([3, 20, 44, 51, 64, 65, 84, 99])
        self.__Check2VarEdges.append([4, 21, 45, 49, 52, 66, 85, 100])
        self.__Check2VarEdges.append([5, 22, 46, 50, 53, 67, 86, 101])
        self.__Check2VarEdges.append([6, 23, 47, 51, 54, 68, 87, 102])
        self.__Check2VarEdges.append([7, 24, 48, 52, 55, 69, 88, 103])
        self.__Check2VarEdges.append([8, 25, 33, 53, 56, 70, 89, 104])
        self.__Check2VarEdges.append([9, 26, 34, 54, 57, 71, 90, 105])
        self.__Check2VarEdges.append([10, 27, 35, 55, 58, 72, 91, 106])
        self.__Check2VarEdges.append([11, 28, 36, 56, 59, 73, 92, 107])
        self.__Check2VarEdges.append([12, 29, 37, 57, 60, 74, 93, 108])
        self.__Check2VarEdges.append([13, 30, 38, 58, 61, 75, 94, 109])
        self.__Check2VarEdges.append([14, 31, 39, 59, 62, 76, 95, 110])
        self.__Check2VarEdges.append([15, 32, 40, 60, 63, 77, 96, 111])
        self.__Check2VarEdges.append([16, 17, 41, 61, 64, 78, 81, 112])
        super().__init__(self.__Check2VarEdges, None, seclength)
        self.maxdepth = 64      # CHECK
